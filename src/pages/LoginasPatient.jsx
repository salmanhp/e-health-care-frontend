...
const LoginasPatient = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://ehealthcare-7fn3.onrender.com/api/plogin', requestOptions)
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <Box>
            ...
            <Paper elevation={10} style={paperStyle}>
                ...
                <Typography align='center' sx={{ margin: '20px 0px' }} variant='h4'>Login as Patient</Typography>
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', rowGap: '15px' }}>
                    ...
                    <Typography align='center'>Don't have an account? <Link color='primary' style={{ textDecoration: 'none' }} to='/signupaspatient'>Sign Up</Link></Typography>
